...
{
    public partial class frmPrintLicenciasMedicas : frmBase
    {
        public frmPrintLicenciasMedicas()
        {
            InitializeComponent();
        }

        private void frmPrintLicenciasMedicas_Load(object sender, EventArgs e)
        {
            this.Limpiar();
