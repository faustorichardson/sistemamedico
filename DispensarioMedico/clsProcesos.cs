    ...
    class clsProcesos
    {
        ...
        public static DataTable DatosGeneral(string tabla, string cFiltro, string cOrderBy)
        {
            ...
            try
            {
                ...
                if (constring == null) { constring = DispensarioMedico.clsConexion.ConectionString; }
        ...
        public void Valida_Keypress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                MessageBox.Show("No se Permiten Letras", "Sistema SysHospitalARD v1.0", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = false;
            ...
            {
                MessageBox.Show("No se Permiten Caracteres Especiales", "Sistema SysHospitalARD v1.0", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = false;
            }
