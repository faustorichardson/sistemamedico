...
namespace DispensarioMedico
{
    ...
    {
        string cCadenaConexion = Conexion.ConectionString;
        string cModo = "Inicio";
...
//            this.dtpFechaDigitada.Value = VFPToolkit.dates.DateTime();
        ...
        private bool ValidaForm()
        {
            ...
            try
            {
                ...
                // txtNotas.Text == "" 
                if (txtDes_pro.Text == "" || txtPrecio.Text == "" || txtCosto.Text == "" || this.txtCod_pro.Text == "")
                {
        ...
        private void Grabar()
        {
            ...
            // Inicio Conexion y transacccion            
            ...
            try
            {
                ...
                oCnn.ConnectionString = cCadenaConexion;
                oCnn.Open();
                ...
                else
                {
                    this.txtCod_pro.Text = "000001";
                        ...
                        this.cboPresentacion.SelectedValue.ToString() + "','" + Convert.ToBoolean(chkInventariable.Checked) + "') ";
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (cCodigo != "" && cCodigo != null)
            {
                ...
                // this.grdDetalle.Rows.Add();
                DataTable dtTmp = Procesos.DatosGeneral("mproduct", " where trim(cod_pro) = '" + cCodigo + "'" ," order by Cod_pro");
                if (dtTmp.Rows.Count > 0)
                {
                    DataRow DR;
                    DR = dtTmp.Rows[0];
