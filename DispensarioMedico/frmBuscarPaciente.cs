...
{
    public partial class frmBuscarPaciente : frmBase
    {
        ...
        private void txtBuscar_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (this.txtBuscar.Text != "")
            {
                ...
                DataTable dsCatalogo = clsProcesos.DatosGeneral("paciente", " where upper(nombre)  like " + cBuscar + " or upper(apellido) like  " + cBuscar, " order by apellido,rango ");
